...
\subsection{The CAP theorem} % (fold)
...
\subsection{Document-oriented databases} % (fold)
...
\subsection{Column-oriented databases} % (fold)
...
\subsection{Graph based databases} % (fold)
